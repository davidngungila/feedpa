    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function decodeContent(contentRaw) {
            if (Array.isArray(contentRaw)) {
                return {
                    text: contentRaw.text || trimUrlList([
                        contentRaw.imageUrl, contentRaw.videoUrl, contentRaw.audioUrl,
                        contentRaw.documentUrl, contentRaw.stickerUrl,
                    ]) || 'Media message',
                    decoded: contentRaw,
                };
            }
            ...
            if (Array.isArray(decoded)) {
                return {
                    text: decoded.text || trimUrlList([
                        decoded.imageUrl, decoded.videoUrl, decoded.audioUrl,
                        decoded.documentUrl, decoded.stickerUrl,
                    ]) || 'Media message',
                    decoded: decoded,
                };
            }
