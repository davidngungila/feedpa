...
class AiChatController extends Controller
{
    ...
    private function getDateRange(string $dateFilter, ?string $startDate = null, ?string $endDate = null): array
    {
        return match ($dateFilter) {
...
IMPORTANT: When answering questions, use this data directly. You can refer to today's data, customers, payment methods, recent transactions, etc. If asked about different time periods (week, month), mention that you can help with that. Be friendly and professional.
SYSTEM_PROMPT;
