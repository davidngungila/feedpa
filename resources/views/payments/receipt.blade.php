     ...
     <div class="container"> 
         ...
         <div class="info-card"> 
             <table class="details-table"> 
                 <tr> 
                     ...
                     <td class="value" style="font-size: 14px;">{{ strtoupper($paymentData['customer']['customerName'] ?? $paymentData['payer_name'] ?? 'Anonymous') }}</td> 
         ...
         <table class="signature-grid"> 
             <tr> 
                 ...
                 <td style="text-align: center; width: 50%;"> 
                     <div class="sig-line"></div> 
                     <div class="sig-text">PAYER'S ACKNOWLEDGMENT</div> 
                 </td> 
             </tr> 
         </table> 
