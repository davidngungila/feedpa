...
<head>
    ...
    <title>Request Timeout - {{ config('app.name') }}</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full mx-4 text-center">
        ...
        <h1 class="text-6xl font-bold text-gray-800 mb-4">408</h1>
        <h2 class="text-2xl font-semibold text-gray-700 mb-4">Request Timeout</h2>
        <p class="text-gray-600 mb-8">The server timed out waiting for your request. Please try again.</p>
