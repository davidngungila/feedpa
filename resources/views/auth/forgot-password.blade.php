...
<head>
    ...
    <title>Forgot Password | FEEDTAN DIGITAL PAYMENT SYSTEM</title>
...
<body class="h-full" :class="darkMode ? 'dark bg-[#0a140e]' : 'bg-[#f0fdf4]'">
    ...
    <!-- Main Content -->
    <div class="fixed inset-0 z-50 flex items-center justify-center" :class="darkMode ? 'bg-[#0a140e]' : 'bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700'">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="you@example.com"
                                   class="w-full pl-10 pr-3 py-3 rounded-xl border focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all"
                                   :class="darkMode?'bg-[#0a140e] border-[#1a3328] text-white placeholder-gray-500':'bg-gray-50 border-primary-200 text-primary-900 placeholder-gray-500'">
                        </div>
                        @error('email')
