    ...
    <div class="card p-6" id="composerCard">
        ...
        <form id="sendGroupMessageForm" action="{{ route('whatsapp.groups.send-message', $group['jid']) }}" method="POST">
            ...
            <div class="composer-panel hidden mt-4 space-y-3" data-panel="location">
                ...
                <input type="text" name="location_caption" class="{{ $composerInputClass }}" placeholder="Caption (optional)">
            </div>
            ...
            <div class="composer-panel hidden mt-4 space-y-3" data-panel="quoted">
                ...
                <textarea name="reply_text" rows="3" placeholder="Type your reply..." class="{{ $composerInputClass }} resize-y"></textarea>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const pollInputClass = 'w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-dark-card text-sm text-primary-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500';
        ...
        function currentTextInput() {
            ...
            if (type === 'quoted') return document.querySelector('.composer-panel[data-panel="quoted"] textarea[name="reply_text"]');
            return null;
        }
